...
public class CircleTest {
    ...
    public void testGetArea() {
        ...
        Circle postiveCircle = new Circle(10, Colour.RED);
        assertEquals(314.1592653589793, postiveCircle.getArea(), delta);

        Circle zeroCircle = new Circle(0, Colour.RED);
        assertEquals(0.0, zeroCircle.getArea(), delta);

        Circle negativeCircle = new Circle(-10, Colour.RED);
        assertEquals(314.1592653589793, negativeCircle.getArea(), delta);

        Circle maxDoubleCircle = new Circle(Double.MAX_VALUE, Colour.RED);
        assertEquals(Double.POSITIVE_INFINITY, maxDoubleCircle.getArea(), delta);

        Circle minDoubleCircle = new Circle(Double.MIN_VALUE, Colour.RED);
