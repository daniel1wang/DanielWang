...
public class TriangleTest {
    ...
    /**
     * Tests for the getArea method for possibilities of base or height: positive negative, zero, maximum double, minimum double.
     */
    @Test
    public void testGetAreaBaseHeight() {
        double delta = 0.000000000000000000000000000000000001;

        Triangle allPositiveTriangle = new Triangle(10, 10, Colour.RED);
        assertEquals(50.0, allPositiveTriangle.getArea(), delta);

        Triangle allNegativeTriangle = new Triangle(-10, -10,Colour.RED);
        assertEquals(50.0, allNegativeTriangle.getArea(), delta);

        Triangle baseNegativeTriangle = new Triangle(-10, 10,Colour.RED);
        assertEquals(-50.0, baseNegativeTriangle.getArea(), delta);

        Triangle heightNegativeTriangle = new Triangle(10, -10,Colour.RED);
        assertEquals(-50.0, heightNegativeTriangle.getArea(), delta);

        Triangle allZeroTriangle = new Triangle(0, 0,Colour.RED);
        assertEquals(0.0, allZeroTriangle.getArea(), delta);

        Triangle baseZeroTriangle = new Triangle(0, 10,Colour.RED);
        assertEquals(0.0, baseZeroTriangle.getArea(), delta);

        Triangle heightZeroTriangle = new Triangle(10, 0,Colour.RED);
        assertEquals(0.0, heightZeroTriangle.getArea(), delta);

        Triangle allMaxDoubleTriangle = new Triangle(Double.MAX_VALUE, Double.MAX_VALUE,Colour.RED);
        assertEquals(Double.POSITIVE_INFINITY, allMaxDoubleTriangle.getArea(), delta);

        Triangle baseMaxDoubleTriangle = new Triangle(Double.MAX_VALUE, 10,Colour.RED);
        assertEquals(Double.POSITIVE_INFINITY, baseMaxDoubleTriangle.getArea(), delta);

        Triangle heightMaxDoubleTriangle = new Triangle(10, Double.MAX_VALUE,Colour.RED);
        assertEquals(Double.POSITIVE_INFINITY, heightMaxDoubleTriangle.getArea(), delta);

        Triangle allMinDoubleTriangle = new Triangle(Double.MIN_VALUE, Double.MIN_VALUE,Colour.RED);
        assertEquals(0.0, allMinDoubleTriangle.getArea(), delta);

        Triangle baseMinDoubleTriangle = new Triangle(Double.MIN_VALUE, 10,Colour.RED);
        assertEquals(0.0, baseMinDoubleTriangle.getArea(), delta);

        Triangle heightMinDoubleTriangle = new Triangle(10, Double.MIN_VALUE,Colour.RED);
        assertEquals(0.0, heightMinDoubleTriangle.getArea(), delta);
    }

    /**
     * Tests getArea method for possibilities of sides: positive negative, zero, max double, min double, NaN
     */
    @Test
